...
export default Electricity = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [gainResources.bind(this, {science: 2}), gainResourcesPer.bind(this, 2, 'science', 'eachCityInHand')]
            // 1: {
            //     produceResource: {
            //         science: 2, 
            //         eachCityInHand: {
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Electricity.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Electricity.jpg')} 
                />
