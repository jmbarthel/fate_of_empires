...
export default Printing = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [drawCard, gainResources.bind(this, {science: 2})]
            // 1: {
            //     draw: 1, 
            //     produceResource: {
            //         science: 2, 
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Printing.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Printing.jpg')} 
                />
