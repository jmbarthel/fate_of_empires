...
export default Medicine = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [drawCard, gainResources.bind(this, {toward: {person: {gold: 3}}})]
            // 1: {
            //     draw: 1, 
            //     produceResource: {
            //         toward: {
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Medicine.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Medicine.jpg')} 
                />
