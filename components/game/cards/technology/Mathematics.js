...
export default Mathematics = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [drawCard, gainResources.bind(this, {science: 1})]
            // 1: {
            //     draw: 1, 
            //     produceResource: {
            //         science: 1
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Mathematics.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Mathematics.jpg')} 
                />
