...
export default Railroad = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [gainResources.bind(this, {science: 3, gold: 2})]
            // 1: {
            //     produceResource: {
            //         science: 3, 
            //         gold: 2
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Railroad.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Railroad.jpg')} 
                />
