...
export default Currency = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [gainResources.bind(this, {gold: 3, science: 3})]
            // 1: {
            //     produceResource: {
            //         gold: 3, 
            //         science: 3
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Currency.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Currency.jpg')} 
                />
