...
export default Navigation = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [advanceTime.bind(this, 1), gainResources.bind(this, {science: 2})]
            // 1: {
            //     advanceTime: 1,
            //     produceResource: {
            //         science: 2, 
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Navigation.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Navigation.jpg')} 
                />
    ...
    return <Image style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Navigation.jpg')} />
}