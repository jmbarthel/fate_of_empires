...
export default CodeofLaws = (props) => {
    props = {
        ...
        choiceCount: 1, 
        choices: {
            1: [gainResources.bind(this, {science: 2, influence: 1})]
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/CodeofLaws.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/CodeofLaws.jpg')} 
                />
