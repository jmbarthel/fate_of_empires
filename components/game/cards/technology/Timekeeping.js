...
export default Timekeeping = (props) => {
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/Timekeeping.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/Timekeeping.jpg')} 
                />
