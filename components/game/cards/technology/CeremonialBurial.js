...
export default CeremonialBurial = (props) => {
    props = {
        ...
        display_name: 'Ceremonial Burial', 
        region: 'yellow',
        cost: {
            gold: 0,
            influence: 0, 
    ...
    if(props.expanded){
        return <Image 
            style={{width: '100%', height: '100%'}} props={props} source={require('../../../../assets/technology/CeremonialBurial.jpg')} />
    } else{
        return (
            <View 
                props={props} 
            ...
            >
                <Image 
                    ...
                    props={props} 
                    source={require('../../../../assets/technology/pics/CeremonialBurial.jpg')} 
                />
