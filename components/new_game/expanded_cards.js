    ...
    calculateSupplyCost = (type) => {
        ...
        if(cardType === 'person'){
            return cardCost 
                ...
                - parseInteger((cardRegion === playerRegion) 
                            ? ((this.props.permanent_cost_reductions['yourRegion']||{})[type]||0) 
                            : ((this.props.permanent_cost_reductions['otherRegion']||{})[type]||0))
            ;
                                ...
                                ? 
                                    <View style={styles.sideBubblesCon}>
                                        ...
                                        >
                                            ...
                                            />
                                            <Text>{this.calculateSupplyCost('gold')}</Text>
                                        </LinearGradient>
                                    </View>
                                : undefined
                            }
                                ...
                                ? 
                                    <View style={styles.sideBubblesCon}>
                                        ...
                                        >
                                            ...
                                            />
                                            <Text>{this.calculateSupplyCost('science')}</Text>
                                        </LinearGradient>
                                    </View>
                                : undefined
                            }
